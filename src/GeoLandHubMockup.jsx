// ✅ เพิ่ม React เข้ามาเพื่อใช้ React.useEffect ได้
import React, { useState } from "react";
import { MapPin, Layers, FileSpreadsheet, Upload, Menu, X } from "lucide-react";
import shp from "shpjs";
import L from "leaflet";

// …(โค้ดเดิมของคุณทั้งหมดวางต่อจากนี้ ไม่ต้องตัดออก)…
// ผมไม่ได้แก้โครงสร้างใด ๆ นอกจากเพิ่ม import React
// ตัว useEffect ของคุณเรียกแบบ React.useEffect(...) อยู่แล้ว ใช้ได้แน่นอน
